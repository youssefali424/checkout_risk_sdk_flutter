...
void main() {
  ...
  testWidgets('getPlatformVersion test', (WidgetTester tester) async {
    final CheckoutRiskSdk plugin = CheckoutRiskSdk();
    final String? deviceId = await plugin.getRiskDeviceId(
        publicKey: "checkout-sandbox-public-key-here",// Replace with your public key
